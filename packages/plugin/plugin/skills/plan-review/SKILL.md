...
3. **Execution graph.** Trace prerequisites, order/owner/state, migrations, generated/docs/package/publication work, cleanup/rollback/stops. Find cycles, gaps, write overlap, unsafe parallelism, stale output, and wrong orchestration timing. The reviewed plan may use dynamic implementation and verification workflows after approval; review never implements.
