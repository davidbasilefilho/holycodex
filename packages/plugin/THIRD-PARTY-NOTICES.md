...
The isolated workflow runtime uses [quickjs-emscripten](https://github.com/justjake/quickjs-emscripten) and QuickJS compiled to WebAssembly. Both projects are distributed under the MIT License; the bundled license is preserved at `plugin/runtime/LICENSE-QUICKJS-EMSCRIPTEN-MIT.txt`.
