...
describe("currentRequestContext", () => {
  it("#given project, user, and install-decision config env #when building request context #then forwards only those keys", () => {
    const context = currentRequestContext({
      LSP_TOOLS_MCP_PROJECT_CONFIG: ".codex/lsp-client.json:.codex/lsp.json",
      LSP_TOOLS_MCP_USER_CONFIG: "~/.codex/lsp.json",
      LSP_TOOLS_MCP_INSTALL_DECISIONS: "~/.codex/lsp-install-decisions.json",
      PATH: "/usr/bin",
      HOME: "/home/me",
    });
