...
const requiredContracts = [
	...
	["members are always real Codex threads, never spawned agents", /NEVER substitute[\s\S]{0,40}spawn_agent/i],
	["thread creation is strict, not a preference", /strict,?\s+not a preference/i],
