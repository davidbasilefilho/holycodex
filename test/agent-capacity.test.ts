...
describe("agent capacity context", () => {
  ...
  it("explains root-inclusive capacity and fallback authority", () => {
    ...
    expect(context).toContain("always delegates at least one bounded task through a CLI workflow");
    expect(context).toContain("targetCalls is soft planning guidance");
