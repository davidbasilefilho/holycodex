...
- Native Effect workflows are the production path; QuickJS is compatibility-only and requires explicit `--compat-quickjs`. Approval happens before effects, runtime owns deterministic mechanics, and Root owns judgment.
